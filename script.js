...
(function () {
  ...
  const beats = [
    ...
    },
    {
      ...
      badges: [1, 2, 3], arrows: ["stem-heart", "stem-lungs"],
      organs: { heart: "fast", lungs: "fast" },
      bpm: 170, brpm: 34,
      caption: "Panic route: alarm and body get so loud that cortex has little room to check.",
      thought: "PANIC!",
      hold: 2100,
    },
    {
      ...
      bpm: 138, brpm: 18,
      caption: "Try the same stumble with one slow breath. The body gives the circuit different data.",
      thought: "Breathe.",
      hold: 1800,
    },
    {
      ...
      badges: [1, 2, 3, 4],
      arrows: ["stem-heart", "stem-lungs", "stem-cortex"],
      organs: { heart: "calm", lungs: "calm" },
      bpm: 96, brpm: 16,
      caption: "Cortex returns to the loop: I tripped, but I am safe enough to check.",
